...
import { publicRegister } from "../utils/api";

const SECRET_KEY = "rpsf2026";
...
export default function PublicRegister() {
  ...
  const [keyValid] = useState(() => {
    const params = new URLSearchParams(window.location.search);
    return params.get("key") === SECRET_KEY;
  });
  ...
  const handlePhotoUpload = (e) => {
    ...
    reader.onload = (event) => {
      setForm({ ...form, photo: file, photoPreview: event.target.result });
    };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.nameEnglish || !form.mobileNumber) {
      alert("Name (English) and Mobile Number are required");
      return;
    }
    ...
    try {
      ...
      payload.photo = form.photoPreview;

      await publicRegister(payload);
      setSubmitted(true);
      setForm(initialForm);
    } catch (err) {
  ...
  // Auto redirect to home after 5 sec on success
  useEffect(() => {
    if (submitted) {
      ...
      <div className="public-register-wrapper">
        ...
        <div className="public-register-card invalid">
          ...
          <p>
            ...
            <br />
            Please contact RPSF admin for a valid link.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="public-register-wrapper">
      <div className="public-register-header">
        <img src="/rpsf-logo.jpg" alt="RPSF" className="public-register-logo" />
        <h1>RPSF Registration Form</h1>
        <p>RPSF TRAINING CENTER RAJAHI CAMP GORAKHPUR</p>
        <p className="motto">तपसा शौर्यसन्धानम्</p>
      </div>

      <form onSubmit={handleSubmit} className="bio-form public-form">
        {/* ============ PHOTO ============ */}
        ...
        <div className="bio-section">
          ...
          <div className="bio-grid">
            <div className="form-field full-width">
              <label>12. Present Posting Details</label>
              <input
                name="presentPosting"
                value={form.presentPosting}
                onChange={handleChange}
                placeholder="Present posting details"
              />
            </div>
            <div className="form-field full-width">
              <label>13. Permanent Posting Details</label>
              <input
                name="permanentPosting"
                value={form.permanentPosting}
                onChange={handleChange}
                placeholder="Permanent posting details"
              />
            </div>
          </div>
        </div>
        ...
        <div className="bio-section">
          ...
          <div className="bio-grid">
            ...
            <div className="form-field">
              <label>19. Emergency Contact No.</label>
              <input
        ...
        <div className="bio-section">
          ...
          <div className="bio-grid">
            ...
            <div className="form-field full-width">
              <label>31. Professional Knowledge — Computer</label>
              <textarea
            ...
            <div className="form-field full-width">
              <label>32. Vocational Training</label>
              <textarea
                name="vocationalTraining"
                value={form.vocationalTraining}
                onChange={handleChange}
                rows="2"
                placeholder="Vocational training..."
              />
            </div>
          </div>
        </div>
        ...
        <div className="bio-section">
          ...
          <div className="bio-grid">
            ...
            <div className="form-field full-width">
              <label>42. Name of Children</label>
              <input
                name="childrenName"
        ...
        <div className="bio-section">
          ...
          <div className="bio-grid">
            <div className="form-field full-width">
              <label>48. Medical History</label>
              <textarea
                name="medicalHistory"
      ...
      <style>{`
        ...
        @media (max-width: 700px) {
          .public-register-wrapper { padding: 20px 12px 40px; }
          .public-register-header h1 { font-size: 24px; letter-spacing: 2px; }
          .public-register-header p { font-size: 11px; }
          .public-register-card { padding: 30px 20px; margin: 30px auto; }
        }
      `}</style>
    </div>
  );
